        ...
        public void onImpression(string adUnitId, AndroidJavaObject impressionData)
        {
            ...
            if (impressionData != null)
            {
                impressData = new ImpressionData
                {
                    ...
                    PublisherRevenuePerImpression = impressionData.Call<string>("getPublisherRevenuePerImpression"),
                    PublisherRevenuePerImpressionInMicros = impressionData.Call<string>("getPublisherRevenuePerImpressionInMicros"),
