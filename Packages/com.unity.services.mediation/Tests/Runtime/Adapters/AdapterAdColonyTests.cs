...
{
    public class AdapterAdColonyTests
    {
        ...
        public IEnumerator SetUp()
        {
            ...
            m_RegularInterstitialAd       = new InterstitialAd(TestConstants.AdUnitRegularInterstitialAdColony);
            m_HeaderBiddingInterstitialAd = new InterstitialAd(TestConstants.AdUnitHeaderBiddingInterstitialAdColony);

            m_RegularRewardedAd       = new RewardedAd(TestConstants.AdUnitRegularRewardedAdColony);
            m_HeaderBiddingRewardedAd = new RewardedAd(TestConstants.AdUnitHeaderBiddingRewardedAdColony);
        }
