...
{
    public class AdapterAdMobTests
    {
        ...
        public IEnumerator SetUp()
        {
            ...
            m_RegularInterstitialAd = new InterstitialAd(TestConstants.AdUnitRegularInterstitialAdMob);
            m_RegularRewardedAd     = new RewardedAd(TestConstants.AdUnitRegularRewardedAdMob);
        }
