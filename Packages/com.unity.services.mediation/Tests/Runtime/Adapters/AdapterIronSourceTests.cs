...
{
    public class AdapterIronSourceTests
    {
        ...
        public IEnumerator SetUp()
        {
            ...
            m_RegularInterstitialAd       = new InterstitialAd(TestConstants.AdUnitRegularInterstitialIronSource);
            m_HeaderBiddingInterstitialAd = new InterstitialAd(TestConstants.AdUnitHeaderBiddingInterstitialIronSource);

            m_RegularRewardedAd       = new RewardedAd(TestConstants.AdUnitRegularRewardedIronSource);
            m_HeaderBiddingRewardedAd = new RewardedAd(TestConstants.AdUnitHeaderBiddingRewardedIronSource);
        }
