...
{
    public class AdapterAppLovinTests
    {
        ...
        public IEnumerator SetUp()
        {
            ...
            m_RegularInterstitialAd = new InterstitialAd(TestConstants.AdUnitRegularInterstitialAppLovin);
            m_RegularRewardedAd     = new RewardedAd(TestConstants.AdUnitRegularRewardedAppLovin);
        }
