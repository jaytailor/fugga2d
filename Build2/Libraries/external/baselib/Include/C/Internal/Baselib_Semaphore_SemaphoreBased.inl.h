...
BASELIB_STATIC_ASSERT(sizeof(Baselib_Semaphore) == PLATFORM_CACHE_LINE_SIZE, "Baselib_Semaphore size should match cacheline size (64bytes)");

BASELIB_INLINE_API Baselib_Semaphore Baselib_Semaphore_Create(void)
{
    Baselib_Semaphore semaphore = {Baselib_SystemSemaphore_Create(), 0, {0}};
    return semaphore;
}
