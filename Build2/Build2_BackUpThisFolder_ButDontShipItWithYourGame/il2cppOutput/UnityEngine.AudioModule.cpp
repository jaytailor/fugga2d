...
bool V_0 = false;
	...
	}
	{
		...
		NullCheck(L_2);
		AudioConfigurationChangeHandler_Invoke_m4DC27DD11512481B60071B20284E6886DAE54DE2(L_2, L_3, NULL);
	}
...
{
		il2cpp_codegen_runtime_class_init_inline(Mobile_t304A73480DF447472BDB16BA19A9E4FE2C8CB2DD_il2cpp_TypeInfo_var);
...
IL_003a:
	...
	}
	{
		...
		bool L_11 = ___mute0;
		NullCheck(L_10);
		Action_1_Invoke_m69C8773D6967F3B224777183E24EA621CE056F8F(L_10, L_11, Action_1_Invoke_m69C8773D6967F3B224777183E24EA621CE056F8F_RuntimeMethod_var);
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Mobile__cctor_mE87CB2BCDD2C53EF6970E99299E60625B194D5E9 (const RuntimeMethod* method) 
{
static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
...
{
		((Mobile_t304A73480DF447472BDB16BA19A9E4FE2C8CB2DD_StaticFields*)il2cpp_codegen_static_fields_for(Mobile_t304A73480DF447472BDB16BA19A9E4FE2C8CB2DD_il2cpp_TypeInfo_var))->___U3CmuteStateU3Ek__BackingField_0 = (bool)0;
		((Mobile_t304A73480DF447472BDB16BA19A9E4FE2C8CB2DD_StaticFields*)il2cpp_codegen_static_fields_for(Mobile_t304A73480DF447472BDB16BA19A9E4FE2C8CB2DD_il2cpp_TypeInfo_var))->____stopAudioOutputOnMute_1 = (bool)0;
		return;
	}
}
#ifdef __clang__
...
bool V_0 = false;
	...
	}
	{
		...
		NullCheck(L_2);
		PCMReaderCallback_Invoke_m76784C690C36B513E2AA5B0E4FD9831B2C7E5152(L_2, L_3, NULL);
	}
...
bool V_0 = false;
	...
	}
	{
		...
		NullCheck(L_2);
		PCMSetPositionCallback_Invoke_m434D4F02FA25F91DF6199EC5A799C551C7F93702(L_2, L_3, NULL);
	}
...
DelegateU5BU5D_tC5AB7E8F745616680F337909D3A8E6C722CDF771* delegateArrayToInvoke = __this->___delegates_13;
	...
	for (il2cpp_array_size_t i = 0; i < length; i++)
	{
		...
		if (___methodIsStatic)
		{
			...
			{
				// closed
				typedef void (*FunctionPointerType) (void*, SingleU5BU5D_t89DEFE97BCEDB5857010E79ECE0F52CF6E93B87C*, const RuntimeMethod*);
...
bool V_0 = false;
	...
	}
	{
		...
		NullCheck(L_2);
		SampleFramesHandler_Invoke_m478D5645634B8C734E58B59CF7750797FC54F1BC(L_2, __this, L_3, NULL);
	}
...
DelegateU5BU5D_tC5AB7E8F745616680F337909D3A8E6C722CDF771* delegateArrayToInvoke = __this->___delegates_13;
	...
	for (il2cpp_array_size_t i = 0; i < length; i++)
	{
		...
		if (___methodIsStatic)
		{
			...
			{
				// closed
				typedef void (*FunctionPointerType) (void*, AudioSampleProvider_t602353124A2F6F2AEC38E56C3C21932344F712E2*, uint32_t, const RuntimeMethod*);
