...
public class BannerAd {
    ...
    public BannerAd(Activity activity, String adUnitId, BannerAdViewSize size, IBannerAdViewListener bannerListener) {
        ...
        bannerAdView.setListener(new IBannerAdViewListener() {
            ...
            @Override
            public void onBannerAdViewFailedLoad(BannerAdView bannerAdView, LoadError loadError, String s) {
                bannerListener.onBannerAdViewFailedLoad(bannerAdView, loadError, s);
            }
